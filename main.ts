...
if (languageAns.language === "English") {
  console.log(
    chalk.bgMagenta.bold.rgb(222, 173, 237)('You have selected "English"')
  );
}
if (languageAns.language === "Urdu") {
  console.log(
    chalk.bgMagentaBright.bold.rgb(222, 173, 237)('You have selected "Urdu"')
  );
}
...
if (pinAnswer.pin === myPin) {
  ...
  if (operationAns.operation === "Withdraw") {
    ...
    if (amountAns.amount > 15000) {
      console.log(
        chalk.bgRed.white.bold("You have crossed transaction limit")
      );
    }
    else if (amountAns.amount >= myBalance) {
      console.log(
        chalk.bgRed.white.bold("Your current balance is insufficient")
      );
    } else {
      console.log(
        chalk.bgMagenta.bold.rgb(222, 173, 237)("Transaction successful")
      );
      myBalance -= amountAns.amount
      console.log(
        chalk.bgMagenta.bold.rgb(
          222,
          173,
          237
